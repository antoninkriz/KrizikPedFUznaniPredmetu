...
cp ../../Database/Schema.sql ./data/dbinit/Procedures.sql
...
echo "---DATA---"
mysql -hlocalhost -P 30006 -uKarolinkaDb -pAsdf.1234 KarolinkaDb < ./data/dbinit/Schema.sql
mysql -hlocalhost -P 30006 -uKarolinkaDb -pAsdf.1234 KarolinkaDb < ./data/dbinit/Procedures.sql
mysql -hlocalhost -P 30006 -uKarolinkaDb -pAsdf.1234 KarolinkaDb < ./data/dbinit/Data.sql
